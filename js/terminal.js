...
let tabAllCommand = ["get-cv", "get-linkedin", "get-github", "information", "get-projet", "theme", "theme.defaut", "theme.atom", "theme.dracula", "theme.tokyo", "theme.ubuntu", "cls", "clear", "projet.[0]", "projet.[1]", "projet.[2]", "projet.[3]", "projet.[4]"];
let tabPressCount = 0;
...
document.addEventListener("keydown", function(event) {
    ...
    if (event.key === 'Enter') {
       ...
       {
        result.innerHTML += '<br><table><thead><tr><th width = "10%">Projet</th><th>Outils</th><th width = "10%">Team</th><th>Description</th><th width = "10%">Voir le projet</th></tr></thead><tbody><tr><td>Gestion étudiant</td><td>Java, JavaFx, SQL, Figma</td><td>Oui</td><td>Ce projet de gestion d&apos;étudiants codé en Java vise à simplifier le processus de gestion des informations étudiantes pour les établissements d&apos;enseignement, en offrant une interface conviviale et des fonctionnalités robustes pour suivre, organiser et gérer les données des étudiants de manière efficace.</td><td><a href="https://github.com/Eliott133/projetGestionEtudiants" target="_blank">Projet</a></td></tr></thead><tbody><tr><td>BoisDuRoy</td><td>HTML, CSS, JS, PHP, SQL, C#, Figma, Git</td><td>Oui</td><td>BoisDuRoy est un projet de gestion de congés, développé en HTML, CSS, JavaScript, PHP et C#, vise à simplifier et rationaliser le processus de demande et de suivi des congés des employés. L&apos;application offre une interface utilisateur ergonomique où les employés peuvent soumettre leurs demandes de congés.</td><td><a href="https://github.com/LouisonFvrs/BoisDuRoy" target="_blank">Projet</a></td></tr><tr><td>Snake</td><td>C#</td><td>Non</td><td>Le projet Snake est une implémentation du célèbre jeu du serpent, développé en utilisant le langage de programmation C#. Ce jeu emblématique consiste à contrôler un serpent qui se déplace sur un plateau, en essayant de manger des aliments pour grandir et marquer des points.</td><td><a href="https://github.com/LouisonFvrs/Snake" target="_blank">Projet</a></td></tr><tr><td>Portfolio Terminal</td><td>HTML, CSS, JS</td><td>Non</td><td>Souhaitant réaliser un portfolio un peu original j&apos;ai eu l&apos;idée de réaliser un site web reproduisant visuelement un portfolio mais en y implémentant les fonctionnalités que peux posséder un terminal. De plus ce portfolio est quant à lui responsive, il peut donc être visiter via un smartphone ou une tablette.</td><td><a href="https://github.com/LouisonFvrs/Portfolio" target="_blank">Projet</a></td></tr><tr>><td>Joach&apos;Autrement</td><td>Laravel, VueJs, JS</td><td>Oui</td><td>Joach&apos;Autrement est un festival organisé par le lycée Joachim Du Bellay, offrant aux étudiants la possibilité de s&apos;inscrire à des activités via une application Laravel. Un administrateur dispose également d&apos;un panneau de gestion pour assurer le bon déroulement du festival.</td><td><a href="https://github.com/joach-autrement/joachautrement" target="_blank">Projet</a></td></tr></tbody></table><br>';
       }
