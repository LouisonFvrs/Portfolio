...
document.addEventListener("keydown", function(event) {
    ...
    if (event.key === 'Enter') {
       ...
       {
        result.innerHTML += '<br><table><thead><tr><th width = "10%">Projet</th><th>Outils</th><th width = "10%">Team</th><th>Description</th><th width = "10%">Voir le projet</th></tr></thead><tbody><tr><td>Gestion étudiant</td><td>Java, JavaFx, SQL, Figma</td><td>Oui</td><td>Ce projet est une application lourde de gestion d&apos;étudiant, on peut visualiser en fonction de ses permissions attribuer lors de votre connexion, vous pourrez créer, modifier, supprimer des étudiants.</td><td><a href="https://github.com/Eliott133/projetGestionEtudiants" target="_blank">Projet</a></td></tr></thead><tbody><tr><td>BoisDuRoy</td><td>HTML, CSS, JS, PHP, SQL, C#, Figma, Git</td><td>Oui</td><td>Le but est de pouvoir visualiser ses informations et effectuer une demande de congé sur une appli web, ces demandes devront être accepter ou non via ld&apos;appli c#.</td><td><a href="https://github.com/LouisonFvrs/BoisDuRoy" target="_blank">Projet</a></td></tr><tr><td>Snake</td><td>C#</td><td>Non</td><td>L&apos;objectif était de reproduire le jeu snake afin de me familiariser avec le language C#.</td><td><a href="https://github.com/LouisonFvrs/Snake" target="_blank">Projet</a></td></tr><tr><td>Portfolio Terminal</td><td>HTML, CSS, JS</td><td>Non</td><td>Souhaitant réaliser un portfolio un peu original j&apos;ai eu l&apos;idée de réaliser un site web reproduisant visuelement un portfolio mais en y implémentant les fonctionnalités que peux posséder un terminal. De plus ce portfolio est quant à lui responsive, il peut donc être visiter via un smartphone ou une tablette.</td><td><a href="https://github.com/LouisonFvrs/Portfolio" target="_blank">Projet</a></td></tr></tbody></table><br>';
       }
